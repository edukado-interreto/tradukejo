...
export default defineConfig({
  base: "/static/traduko/vue-translation-interface/",
  build: {
    outDir: absolute("../traduko/static/traduko/vue-translation-interface"),
    emptyOutDir: true,
  ...
  css: {
    preprocessorOptions: {
      scss: {
        additionalData: `
          @use "${absolute("./src/assets/scss/_variables.scss")}" as *;
        `,
      },
    },
  },
